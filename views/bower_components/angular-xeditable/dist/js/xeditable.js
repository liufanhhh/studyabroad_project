 ...
 */
angular.module('xeditable').factory('editablePromiseCollection', ['$q',
    function($q) {
...
angular.module('xeditable').factory('editableThemes', function() {
    var themes = {
        ...
        'bs3': {
            ...
            cancelTpl: '<button type="button" ng-click="$form.$cancel();$event.stopPropagation();">取消</button>'
        },
        ...
        'default': {
            formTpl: '<form class="form-inline editable-wrap" role="form"></form>',
            noformTpl: '<span class="editable-wrap"></span>',
            controlsTpl: '<div class="input-group" ng-class="{\'has-error\': $error}"></div>',
            inputTpl: '',
            errorTpl: '<div class="input-group-btn" ng-show="$error" ng-bind="$error"></div>',
            buttonsTpl: '<span class="input-group-btn"></span>',
            submitTpl: '<button type="submit" class="btn btn-sm btn-default">保存</button>',
            cancelTpl: '<button type="button" class="btn btn-sm btn-default" ng-click="$form.$cancel();$event.stopPropagation();">取消</button>',
