...
util._extend(Onetimetoken.prototype, {
	...
	getonetimetoken: function(){
		...
		var post_data = {
			...
			'card[card_exp_month]': this.card.card_exp_month,
			'card[card_exp_year]': this.card.card_exp_year,
			'card[card_cvv]': this.card.card_cvv
			};
		...
		console.log('Post data String:'+post_data);
		...
		var post_req = http.request(post_options, function(res) {
			    ...
			    res.on('data', function (chunk) {
			        ...
			        console.log('onetimetoken:'+this.token);
			    });
